...
///
/// Created by Auro on 05/01/23 at 9:43 PM
///

class ApprovedVendorsController extends GetxController
  ...
  /// remove
  handleVendorRemove(VendorDatum v, {int status = 1}) async {
    ...
    try {
      await ApiCall.patch(ApiRoutes.vendors, id: v.id!);
      SnackBarHelper.show(
