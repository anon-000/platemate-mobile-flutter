...
class VendorPackagesController extends GetxController
    with StateMixin<List<VendorPackageDatum>> {
  ...
  void getData() async {
    ...
    try {
      ...
      final response = List<VendorPackageDatum>.from(
          result.data["data"].map((e) => VendorPackageDatum.fromJson(e)));
