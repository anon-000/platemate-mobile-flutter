...
class BookingDistributionChart extends StatefulWidget {
  final Map<String, BookingReport?>? data;

  const BookingDistributionChart(this.data, {Key? key}) : super(key: key);

  @override
  State<BookingDistributionChart> createState() =>
      _BookingDistributionChartState();
}

class _BookingDistributionChartState extends State<BookingDistributionChart> {
  ...
  Widget build(BuildContext context) {
    List<charts.Series<BookingReport, String>> series = [
      charts.Series(
        ...
        measureFn: (BookingReport series, _) => series.upOrDownPercentage,
